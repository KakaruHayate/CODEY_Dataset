...
**然而使用本数据集时，除了遵守CC BY-NC-SA 4.0许可外，您还需要注意以下几点**
 ...
 - 包括本项目在内和使用本项目素材制作的作品（包括音视频以及使用本数据集训练的AI模型），官方均有权力进行监管，官方随时有权利禁止该数据集以及其他衍生项目成果（如AI模型）的分发，请在使用本数据集前三思。
 
 - 你不可以将本数据集中的音频文件作为SVC技术（例如SoVits、DDSP-SVC、Diffusion-SVC、RVC）的输入源进行使用，且不建议作为SVC技术的训练数据进行使用，按照CC BY-NC-SA 4.0协议本条限制是无效的，但还是希望使用者可以遵守。
